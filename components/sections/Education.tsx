      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
        {education.map((edu, index) => (
          <motion.div
            ...
            className='relative h-full p-6 rounded-xl bg-surface border border-border hover:border-accent/30 transition-all duration-300 hover:shadow-lg hover:shadow-accent/5 group flex flex-col'
          >
            {/* Top Accent */}
